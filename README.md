...
5. On the **Bulk create user** page, under Upload your CSV file,  I clickd on the blue folder logo to locate and select my file. Once I selected the file and clicked **Submit**, the system will begin validating the CSV file:
